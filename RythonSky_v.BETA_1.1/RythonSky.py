...
class Commands:
    ...
    def hunter(self):
        os.system('python tools\social-hunt.py')
        banner()

    def embomb(self):
        os.system('python tools\email-bomb.py')
        banner()

    def locait(self):
        os.system('python tools\location-track.py')
        banner()

    def scanner(self):
        os.system('python tools\port-scanner.py')
        banner()

    def changelog(self):
        c_file = open('change_log', 'r')
